...
app.router.get(/\/examples\/[\w\.\_\-]*/, staticServer);
app.router.get(/\/javascripts\/[\w\.\_\-]*/, staticServer);
app.router.get(/\/stylesheets\/[\w\.\_\-]*/, staticServer);
app.router.get(/\/stylesheets\/images\/[\w\.\_\-]*/, staticServer);
